    ...
    public class AuthController : CommonController
    {
        ...
        public JsonResult LogIn([FromBody] LoginModel model)
        {
            ...
            using (var connection = new MySqlConnection(_connectionString))
            {
                ...
                var query = @"SELECT PasswordHash, u.RoleId, u.organizationid, r.Rolename, o.organizationname, u.Id FROM User u 
        ...
        [HttpPost]
        public JsonResult Register([FromBody] LoginModel model)
        {
        ...
        public int RegisterNewUser(LoginModel model)
        {
            ...
            if (string.IsNullOrEmpty(model.Password) || string.IsNullOrEmpty(model.Email) || string.IsNullOrEmpty(model.Roleid.ToString()) || string.IsNullOrEmpty(model.Organizationid.ToString()))
            {
            ...
            using (var connection = new MySqlConnection(_connectionString))
            {
                ...
                var query = @"SELECT COUNT(*) as cntUser, RoleId, organizationid FROM User WHERE  Email = @Email AND Roleid = @RoleId AND OrganizationId = @OrganizationId";
                using (var command = new MySqlCommand(query, connection))
                {
                ...
                string insertQuery = "INSERT INTO User (PasswordHash, Email, Mobile, Adhar, Roleid, OrganizationId) VALUES (@PasswordHash, @Email, @Mobile, @Adhar, @RoleId, @OrganizationId)";
